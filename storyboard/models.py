...
class Storyboard(models.Model):
    ...
    description = models.TextField(max_length=10000, help_text="Original text description of the scene")
...
class StoryboardPanel(models.Model):
    ...
    description = models.TextField(max_length=2000, help_text="Description of this panel")
    image = models.ImageField(upload_to='storyboard_panels/', blank=True, null=True)
    notes = models.TextField(blank=True, max_length=1000, help_text="Additional notes or direction for this panel")
    image_prompt = models.TextField(blank=True, max_length=2000, help_text="Prompt that will be sent to Stability AI for this panel")
